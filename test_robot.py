...
def test_back_track_after_multi_moves(robot):
    robot.move()
    robot.move()
    robot.move()
    robot.turn()
...
def test_back_track_initial(robot):
    robot.move()
    robot.turn()
    robot.move()
    robot.move()
